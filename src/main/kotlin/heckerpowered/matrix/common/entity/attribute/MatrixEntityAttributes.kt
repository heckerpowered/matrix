...
object MatrixEntityAttributes {
    ...
    fun onInitialize() {
        ...
        FabricDefaultAttributeRegistry.register(EntityType.WARDEN, WardenEntity.addAttributes().add(MAGIC_RESISTANCE, 2.0))
    }
    ...
    val LivingEntity.adjustedManaResistance: Double
        get() = magicResistance * when (world.difficulty) {
