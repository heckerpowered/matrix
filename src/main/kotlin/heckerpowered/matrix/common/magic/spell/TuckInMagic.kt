...
object TuckInMagic : Magic(
    ...
    override fun cast(invocation: MagicInvocation) {
        ...
        val attackDamage = caster.getAttributeValue(EntityAttributes.GENERIC_ATTACK_DAMAGE)
    ...
    private fun consumeFromAbsorptionThenHealth(caster: LivingEntity, consumptionAmount: Double) {
        ...
        caster.setAbsorptionAmountUnclamped((currentAbsorptionAmount - absorptionConsumptionAmount).toFloat())
