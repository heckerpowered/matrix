...
import heckerpowered.matrix.common.magic.core.defaultMagicDamageSource
import heckerpowered.matrix.common.magic.core.removeSourceIfSpoofed
 ...
 * - Carries execution-scoped data via [ExecutionPayload].
 *
 * Design notes:
...
data class MagicInvocation(
    ...
    companion object {
         ...
         */
        fun fromEntity(caster: PlayerEntity, target: LivingEntity, payload: ExecutionPayload = ExecutionPayload()): MagicInvocation {
