...
class DevEntity(entityType: EntityType<out DevEntity>, level: Level) : PathfinderMob(entityType, level), MatrixLivingEntity {
    ...
    private val bossBar = ServerBossEvent(uuid, displayName, BossEvent.BossBarColor.BLUE, BossEvent.BossBarOverlay.NOTCHED_20)

    constructor(level: Level) : this(ModEntityTypes.devEntity, level)
    ...
    override fun hurtServer(level: net.minecraft.server.level.ServerLevel, source: DamageSource, damage: Float): Boolean {
    ...
    override fun customServerAiStep(level: net.minecraft.server.level.ServerLevel) {
