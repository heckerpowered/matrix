...
object ChannelQueueTicker : EntityUpdateRule {
    ...
    override fun onUpdate(context: EntityUpdateContext) {
        ...
        for (queue in entity.channelQueues.values) {
            ...
            // Both client and server advance channel queues locally.
            // The client uses this for prediction / UI progress only.
            // Only the server commits completed channels and runs cast effects.
