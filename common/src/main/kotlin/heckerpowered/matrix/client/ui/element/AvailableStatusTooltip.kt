...
object AvailableStatusTooltip {
    ...
    private var currentStatus = LMagicAvailableStatus.AVAILABLE
    private var displayStatus = LMagicAvailableStatus.AVAILABLE
    ...
    fun render(drawContext: GuiGraphicsExtractor, renderer: LegacyMatrixUIRenderer, status: LMagicAvailableStatus) {
        ...
        if (currentStatus != status && status != LMagicAvailableStatus.AVAILABLE) {
