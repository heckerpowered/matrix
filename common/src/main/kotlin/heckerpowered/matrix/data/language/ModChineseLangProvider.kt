...
class ModChineseLangProvider(
    fabricPackOutput: FabricPackOutput,
    registryLookup: CompletableFuture<HolderLookup.Provider>,
) : FabricLanguageProvider(fabricPackOutput, "zh_cn", registryLookup) {
    ...
    """.trimIndent()
        ...
        translationBuilder.add(MatrixLanguage.wizardHelmetBloodPactExchangeRate.key, "血之契约兑换效率: ")
